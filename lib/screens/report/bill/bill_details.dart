...
class BillDetails extends StatefulWidget {
  ...
  static const routeName ='\bill Details';
...
class _BillDetailsState extends State<BillDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final billNo = args['data4'] as String;
    ...
    Future<List<Item>> fetchQI() async {
      final response = await http.get(Uri.parse('https://ustad-f34a1-default-rtdb.firebaseio.com/Bill/$root.json'));
      print('Bill');
      if (response.statusCode == 200) {
        ...
        for(var i in data['itemList']){
          total = total + double.parse(i['qitemTotalPrice'].toString());
          qitems.add(
              Item(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () async {
            final pdf = await createPDF(qitems, itemsPerPage,name,phone,address,prpo,total);
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(child: Text('Bill No: $billNo')),
                            Center(child: Text('Address: $address')),
                            Center(child: Text('Due: $due tk, ' +'Total: $total tk')),
                          ],
                        ),
                      ),
                    ),
  ...
  Future<Uint8List> createPDF(List<Item> items, int itemsPerPage,name,phone,address,prpo,double total) async {
                              ...
                              pw.Row(
                                ...
                                children: [
                                  ...
                                  pw.Column(
                                    ...
                                    children: [
                                      pw.Text('Bill No: $quotationNumber'),
                              ...
                              pw.Row(
                                ...
                                children: [
                                  ...
                                  pw.Column(
                                    crossAxisAlignment: pw.CrossAxisAlignment.end,
                                    children: [
                                      pw.Text('Bill No: '+quotationNumber.toString()),
